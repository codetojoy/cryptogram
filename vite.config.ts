...
// so `npm run dev` and root deploys serve from '/'; set BASE_PATH=/cryptogram
// for a gh-pages build. SvelteKit requires '' or a string starting with '/', so
...
// won't be reflected — that's acceptable per the spec.
const appVersion = pkg.version;
// Displayed as dd-MMM-YYYY HH:mm tz in Atlantic Time (e.g. 13-JUN-2026 15:30 ADT).
// America/Halifax gives the correct ADT/AST abbreviation and offset.
